...
class Coin:
    ...
    price_change_percentage_24:float
    
    def __str__(self) -> str:
        return f'{self.name} {self.symbol}: Euro {self.current_price:,}'
...
def get_coins() -> list[Coin]:
    ...
    for item in json():
        current_coin: Coin = Coin(
            ...
            low_24h=item.get('high_24h'),
            price_change_24h=item.get('price_change_24h'),
            price_change_percentage_24=item.get('price_change_percentage_24')                
        )
